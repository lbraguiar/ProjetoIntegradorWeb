...
namespace mentoring.Models
{
    ...
    {
        private const string DadosConexao = "Database=mentoring;Data source=localhost;User Id=root;";
        ...
        public void inserir(Servico serv)
        {
            ...
            String Query = "insert into Servico (Nome, Preco, DataServico, Colaborador) values (@Nome, @Preco, @DataServico, @Colaborador)";
        ...
        public void atualizar(Servico serv)
        {
            ...
            String Query = "Update PacoteTuristico SET Nome=@Nome, Preco=@Preco, DataServico=@DataServico, Colaborador=@Colaborador Where Id=@Id";
